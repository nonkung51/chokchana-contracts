...
async function main() {
	...
	const ticket = await _ticket.deploy(true, 0, 9999);
    ...
    await thbToken.approve(lottery.address, 1000000);

    await lottery.setlockBeforeDraw(60);
    await lottery.setNextDraw(120);
    await lottery.buyTicket(2000);
}
